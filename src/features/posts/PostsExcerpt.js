...
// let PostsExcerpt = ({ post }) => { // when using .memo()
...
// PostsExcerpt renders all the 100 excerpts everytime a change happens. Ex: the increaseCount is clicked. To avoid this lets use .memo().
